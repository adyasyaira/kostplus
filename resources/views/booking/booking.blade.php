...
<body>
    ...
    <div class="judul-kost container">
        <h4>Kost Ibani</h4>
    </div>
    <div class="container">
        <table borde="">
            <tr>
                <td rowspan="2">
                    <div class="col"><img src="images/img.jpg" alt="" height="450" width="720"></div>
                </td>
                <td>
                    <div class="col"><img src="images/img1.jpg" alt="" height="230" width="555"></div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="col"><img src="images/img2.png" alt="" height="230" width="555"></div>
                </td>
            </tr>
        </table>
    </div>
  ...
  <div class="row row-cols-6">
    <div class="col"><img src="images/img.jpg" alt="" height="478" width="742"></div>
    <div class="col"><img src="images/img1.jpg" alt=""height="230" width="555" ></div>
</div>
  <div class="col-2">
    <div class="col"><img src="images/img2.png" alt=""height="230" width="555"></div>
    ...
    <div class="container text-center">
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#">Kost Putri</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Condong Catur</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">2 Kamar Kosong</a>
            </li>
            <li class="nav-item">
                <a class="nav-link disabled" p class="right" text-bold>
                    <h3>RP 1.500.000</h3>
                    </p>
                </a>
            </li>
        ...
        <div class="container text-center">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">Peraturan Kost</a>
                </li>
                <li class="nav-item">
                    <!-- Button trigger modal -->
                    <button class="btn btn-outline-secondary" type="" data-bs-toggle="dropdown" aria-expended="false"
                        class="nav-link" aria-current="page" href="#">Chat Pemilik</button>
                <li class="nav-item">
                    <!-- Button trigger modal -->
                    <button class="btn btn-outline-secondary" class="button" data-bs-toggle="modal"
                        data-bs-target="#staticBackdrop">Ajukan sewa</button>

        </div>
        <div class="container text-center">
            <table class="table table-sm">
                <caption>Peraturan Kost</caption>
                <thead>
                    <caption>Dilarang membawa hewan</caption>
                </thead>
                <tbody>
                    <caption>Dilarang berisik diatas Jam 12 malam</caption>
                </tbody>
                <tbody>
                    <caption>Bertamu harap izin</caption>
            </table>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="staticBackdropLabel">RP 1.500.000/bulan</h1>
                            ...
                            <div class="modal-body">
                                ...
                                <button class="btn btn-outline-secondary dropdown-toggle" type="button"
                                    data-bs-toggle="dropdown" aria-expanded="false">waktu sewa kost</button>
                                <!-- Button trigger modal -->
                                <div class="container text-center">
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#staticBackdrop">Ajukan Sewa
                                    </button>
                                    <div class="">
                                        <div class="modal-header">
